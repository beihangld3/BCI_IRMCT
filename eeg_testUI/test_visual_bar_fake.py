...
WITH_Robot= False
# classifier
CLS_FILE= r'E:\DongClf\classifier-64bit.pcl'

# protocol: 
trials_each= 2   # put it to a small number for debug  30
...
#	while True:
	while (trial<= num_trials):
		...
		if event=='trial_end':
			...
			if WITH_Robot:
				print('>> Pushed Rex action', robot_action)
				os.system('RexSimpleControl.exe %d'% robot_action)    # Rex control
